...
myProgramSpawner = "rofi -combi-modi window,drun -font 'Inconsolata 15' -show combi -show-icons"
------------------------------------------------------------------------
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch rofi
    , ((modm,              xK_slash    ), spawn myProgramSpawner)
    -- launch gmrun
    , ((modm .|. shiftMask, xK_p     ), spawn "gmrun")

    -- take full screen screenshot
    , ((modm, xK_Print), spawn "maim ~/Pictures/screenshots/$(date +%s).png -u")

    -- take selection screenshot
    , ((modm .|. shiftMask, xK_Print), spawn "maim ~/Pictures/screenshots/$(date +%s).png -s -u")
...
myStartupHook = do
    ...
    spawnOnce "compton &"
    spawnOnce "xmodmap -e 'keycode 64 = Shift_L'"
